This project is part of my Data Analytics portfolio showcasing my ability to analyze and visualize global datasets using interactive dashboards.

# World-Growth-Trends-2026-
This project is a data visualization dashboard that analyzes global population patterns, fertility rates, migration trends, and urbanization across countries in 2026.
The dashboard provides a high-level overview of how population characteristics vary globally and highlights key relationships between demographic indicators.

 📊 Dashboard Features
	•	Global Population Overview
	•	Total Population: 8.3 billion
	•	Median Age: 32 years
	•	Fertility Rate: 2.27
	•	Population Density Map
	•	Geographic visualization of population concentration across continents
	•	Top Countries by Population
	•	India, China, USA, Indonesia, Pakistan, Nigeria
	•	Fertility vs Median Age (Scatter Plot)
	•	Shows inverse relationship between fertility and age
	•	Urban Population Analysis
	•	Comparison of urbanization levels by country
	•	Net Migration Trends
	•	Top 10 countries with highest migration inflows/outflows
